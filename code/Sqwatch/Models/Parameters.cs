...
namespace Sqwatch.Models
{
    public class Parameters
    {
        ...
        [Option('i', "queryinterval", HelpText = "Interval in milliseconds between query executions.")]
        ...
        [Option('e', "fileexists", HelpText = "If the output file exists, perform this action.")]
